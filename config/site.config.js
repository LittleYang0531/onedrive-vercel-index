...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'littleyang0531@littleyang.onmicrosoft.com',
  ...
  title: "LittleYang0531's OneDrive",
  ...
  email: 'mailto:admin@littleyang.ml',
